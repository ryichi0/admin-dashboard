...
export default function SvgApp({ className }) {
  return (
    <svg className={`${className} dashboard-icon filled-icon`} viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
